	...
	for zb0001 > 0 {
		...
		case "Signers":
			...
			if cap(z.Signers) >= int(zb0002) {
				...
				z.Signers = make([]uint32, zb0002)
			}
			for za0001 := range z.Signers {
				z.Signers[za0001], err = dc.ReadUint32()
				if err != nil {
					err = msgp.WrapError(err, "Signers", za0001)
					return
				}
			}
		case "Signature":
...
func (z *Signature) EncodeMsg(en *msgp.Writer) (err error) {
	...
	for za0001 := range z.Signers {
		err = en.WriteUint32(z.Signers[za0001])
		if err != nil {
			err = msgp.WrapError(err, "Signers", za0001)
			return
		}
...
func (z *Signature) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0001 := range z.Signers {
		o = msgp.AppendUint32(o, z.Signers[za0001])
	}
	// string "Signature"
...
func (z *Signature) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "Signers":
			...
			for za0001 := range z.Signers {
				z.Signers[za0001], bts, err = msgp.ReadUint32Bytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "Signers", za0001)
					return
				}
