...
func init() {
	...
	RegisterValidatorGenerator("ISOWNER", WrapStatelessValidator(IsOwner))
	RegisterValidatorGenerator("ISRECIPIENT", WrapStatelessValidator(IsTokenRecipient))
	RegisterValidatorGenerator("HASBURN", HasBurnGenerator)
}
