...
require (
	...
	github.com/ipfs/go-ipld-format v0.8.0 // indirect
	...
	github.com/multiformats/go-multihash v0.0.0-20180609032256-8be2a682ab9f // indirect
	...
	go.dedis.ch/kyber/v3 v3.0.0-20190125132016-89ca87513151
